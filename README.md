...
- The selection layer is edge-first: `90/270` edge candidates are preferred, same-angle base candidates are fallback-only, and low-confidence edge reads can still be rejected at the final gate.
